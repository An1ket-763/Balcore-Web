...
export const tokenizationSection: DocSection = {
    id: "tokenization",
...
The scope of tokenization extends far beyond cryptocurrency. Every major asset class is being transformed:

| Asset Class | Traditional Access | Tokenized Access |
|------------|-------------------|-----------------|
| Equities (Stocks) | Brokerage account, KYC, trading hours, settlement T+2 | Tokenized shares tradeable 24/7, fractional ownership, instant settlement |
| Government & Corporate Bonds | Minimum $1,000–$250,000 investment, institutional focus | Fractional bond tokens from $1, direct yield distribution to wallet |
| Real Estate | $50,000–$1M+ minimum, illiquid, geographic restrictions | Fractional property tokens, global access, automated rent distribution |
| Commodities (Gold, Oil, Wheat) | Futures contracts, ETFs, limited direct access | Token represents direct commodity exposure, tradeable globally 24/7 |
| Private Equity & Venture | Accredited investors only, $250,000+ minimums | Tokenized fund shares open to global participants, automated distributions |
...
A market maker is an entity that continuously buys and sells an asset, providing liquidity so that other traders can always find a counterparty. Without market makers, trading would be slow, expensive, and unpredictable.

Market makers profit from the spread — the small difference between the price they buy at and the price they sell at. On high-volume assets like Apple stock or gold, this spread is tiny but applied millions of times per day, generating enormous profits.
...
Becoming a market maker in traditional finance requires:

- Regulatory approval and licenses (millions of dollars, years of process)
- Direct market access agreements with exchanges (institutional-only)
- Millions or billions in capital to maintain competitive positions
- Co-location servers physically adjacent to exchange data centers
- Teams of quantitative analysts, engineers, and compliance professionals
...
This is not theoretical. Major institutions are already building the tokenized asset future:

| Institution | Tokenized Asset | What It Means |
|------------|----------------|---------------|
| BlackRock | BUIDL — tokenized US Treasury fund | World's largest asset manager issuing on-chain government bonds |
| Franklin Templeton | BENJI — on-chain money market fund | Mutual fund tokens on Stellar and Polygon |
| JPMorgan | JPM Coin, Onyx platform | Institutional-grade blockchain settlements processing billions daily |
...
- Protecting against impermanent loss through a triple-layer system
- Earning passive yield on the 90% not actively deployed
